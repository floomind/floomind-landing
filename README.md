...
_Landing bilingüe con cuenta regresiva, video de bienvenida, formulario de postulación y un flujo de emails que acompaña al candidato por cada fase del proceso de selección._
...
![Diseño de Producto](https://img.shields.io/badge/Rol-Dise%C3%B1o_de_Producto_%26_UX-8B5CF6?style=for-the-badge)
...
![i18n](https://img.shields.io/badge/Bilingüe-ES_%2F_EN-1B263B?style=for-the-badge)
...
Landing page del proyecto Floomind orientada a **reclutar talento** para sumarse al equipo. Combina una narrativa de misión (bienestar y eficiencia cognitiva con IA), una cuenta regresiva que genera urgencia, un video de presentación y un formulario de postulación que da inicio a un proceso de selección guiado por email.
...
- 🛡️ **Protección anti-spam** con Google reCAPTCHA.
...
Construido en **React** (JavaScript), con **Google reCAPTCHA** para la protección del formulario, soporte **bilingüe (ES/EN)** y desplegado sobre hosting propio con HTTPS.
